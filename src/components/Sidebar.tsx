      ...
      <div>
        <div className="sidebar-header">
          <Link href="/quotation" className="sidebar-logo">
            ...
            {!sidebarCollapsed && <span className="logo-text">GlassFlow</span>}
          </Link>
          <button
      ...
      <div>
        <div className="sidebar-sync-container">
          ...
          >
            ...
            {!sidebarCollapsed && <span className="sync-text">{isSyncing ? 'Syncing...' : 'Sync Data'}</span>}
          </button>
          {!sidebarCollapsed && lastSynced && (
            <p className="sync-details">Last: {lastSynced}</p>
          )}
        </div>
